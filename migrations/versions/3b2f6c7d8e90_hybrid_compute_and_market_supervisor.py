...
def upgrade() -> None:
    op.create_table(
        ...
        sa.CheckConstraint("estimated_runtime_seconds > 0", name="compute_job_runtime_positive"),
    ...
    op.create_index(
        op.f("ix_compute_job_transitions_job_id"), "compute_job_transitions", ["job_id"]
    )
    op.create_index(
        op.f("ix_compute_job_transitions_to_state"), "compute_job_transitions", ["to_state"]
    )
    op.create_index(
        op.f("ix_compute_job_transitions_created_at"), "compute_job_transitions", ["created_at"]
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "observed_usd IS NULL OR observed_usd >= 0", name="cloud_usage_observed_nonnegative"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "last_signal_scan_at", packages.database.types.UTCDateTime(timezone=True), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "market_timestamp", packages.database.types.UTCDateTime(timezone=True), nullable=True
        ),
        sa.Column(
            "received_at", packages.database.types.UTCDateTime(timezone=True), nullable=False
        ),
        sa.Column(
            "processed_at", packages.database.types.UTCDateTime(timezone=True), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "cooldown_until", packages.database.types.UTCDateTime(timezone=True), nullable=True
        ),
        sa.Column(
            "last_seen_at", packages.database.types.UTCDateTime(timezone=True), nullable=False
        ),
        sa.Column("created_at", packages.database.types.UTCDateTime(timezone=True), nullable=False),
        sa.CheckConstraint(
