...
test("authenticated workspace research workflow has no severe console errors", async ({ page }) => {
  ...
  await page.getByRole("link", { name: "Economic Graph" }).click();
  ...
  await page.getByRole("link", { name: "Driver Profiles" }).click();
  ...
  await page.getByRole("link", { name: "Entity Resolution" }).click();
