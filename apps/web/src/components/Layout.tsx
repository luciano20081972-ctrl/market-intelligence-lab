...
export function Layout() {
  return <div className="app-shell">
    <aside className="sidebar">
      <div className="brand"><span className="brand-mark">MIL</span><div>Market Intelligence<small>Research Lab · v0.3.0</small></div></div>
    ...
    <div className="main-column">
      <header className="topbar"><div><b>Research workspace</b><span>Simulation only</span></div><span className="version-chip">v0.3.0</span></header>
      <DemoWarning />
      <main><Outlet /></main>
    </div>
  </div>;
