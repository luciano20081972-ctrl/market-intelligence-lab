...
Market Intelligence Lab v0.5.0 is an authenticated research and simulation application. It must not be used as a brokerage gateway or real-money execution system.
...
- PostgreSQL RLS is not enabled; application-level tenant isolation is mandatory and tested.
